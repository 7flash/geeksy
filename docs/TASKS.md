...
- [ ] **Surface heartbeat core memory somewhere user-visible** — `core_memory` now persists during pruning, but there is no clear UI/debug surface yet to inspect what heartbeat retained.
